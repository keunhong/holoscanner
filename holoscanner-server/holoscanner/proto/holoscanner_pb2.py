...
_MESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VERIFIED', index=8, number=23,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_POSITION', index=9, number=40,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_READY', index=10, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_SET_NICKNAME', index=11, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLEAR_MESHES', index=12, number=100,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLEAR_GAME_STATE', index=13, number=101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_TARGETS', index=14, number=102,
      options=None,
      type=None),
  ],
