...
_MESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TARGET_FOUND', index=6, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLEAR_MESHES', index=7, number=100,
      options=None,
      type=None),
  ],
...
_MESH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='triangles', full_name='Holoscanner.Proto.Mesh.triangles', index=5,
