...
_MESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLEAR_GAME_STATE', index=9, number=101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_TARGETS', index=10, number=102,
      options=None,
      type=None),
  ],
