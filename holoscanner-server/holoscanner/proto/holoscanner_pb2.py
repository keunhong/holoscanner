...
_MESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GAME_STATE', index=5, number=13,
      options=None,
      type=None),
  ],
...
_GAMESTATE.fields_by_name['targets'].message_type = _VEC3D
